...
1. Initialize a translations structure for your project.
2. Helps you write literal and parametrized translations using JSON files.
2. Check if all of your translation files comply with the base translations.
3. Auto-fill the missing fields in the non-complying translation files.
4. Generate ready-to-use clients for your programming language (currently, only Typescript is supported).
